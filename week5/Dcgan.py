...
def buildGenerator(input_var=None):
    ...
    layer = batch_norm(TransposedConv2DLayer(layer, 64, 5, stride=2, nonlinearity=lrelu))
    layer = batch_norm(TransposedConv2DLayer(layer, 64, 4, stride=2, nonlinearity=lrelu))
